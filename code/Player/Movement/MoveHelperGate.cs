...
public struct MoveHelperGate
{
	...
	/// </summary>
	public GatewayTraceResult TraceDirection( Vector3 down )
	{
	...
	public float TryMove( float timestep )
	{
		...
		for ( int bump = 0; bump < moveplanes.Max; bump++ )
		{
			...
			if ( pm.Hit )
			{
				...
				Velocity = pm.Direction.Normal * Velocity.Length;
			}
			else
			{
	...
	/// </summary>
	public bool IsFloor( GatewayTraceResult tr )
	{
	...
	/// </summary>
	public GatewayTraceResult TraceMove( Vector3 delta )
	{
